...
export const bulkCreateTimeEntriesSchema = z.object({
  entries: z
    ...
    .max(100, 'Maximum 100 entries at once'),
});
...
export const timeReportRequestSchema = z
  .object({
    ...
    projectId: z.string().uuid().optional(),
    groupBy: z
      .enum(['user', 'project', 'task', 'date', 'week', 'month'])
      .optional(),
 ...
 */
export const timeSummaryRequestSchema = z
  .object({
    startDate: z.string().datetime(),
    endDate: z.string().datetime(),
    userId: z.string().uuid().optional(),
 ...
 */
export const updateBillableHoursSettingsSchema =
  billableHoursSettingsSchema.partial();
...
export type BulkCreateTimeEntriesInput = z.infer<
  typeof bulkCreateTimeEntriesSchema
>;
export type BulkUpdateTimeEntriesInput = z.infer<
  typeof bulkUpdateTimeEntriesSchema
>;
...
export type BillableHoursSettingsInput = z.infer<
  typeof billableHoursSettingsSchema
>;
