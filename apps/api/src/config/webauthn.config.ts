 ...
 */
export const attestation: 'none' | 'indirect' | 'direct' | 'enterprise' =
  'none';
...
export const authenticatorSelection = {
   ...
   */
  authenticatorAttachment: undefined as
    | 'platform'
    | 'cross-platform'
    | undefined,
...
export const ErrorMessages = {
  CHALLENGE_MISMATCH:
    'Challenge verification failed - possible tampering detected',
  CHALLENGE_MISSING:
    'No challenge found - please restart registration/authentication',
