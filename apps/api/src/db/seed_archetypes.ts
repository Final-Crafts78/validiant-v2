  ...
  const archetypes = [
    {
      ...
      description:
        'Standard background check for candidates, including ID, education, and criminal history verification.',
    ...
    },
    {
      ...
      description:
        'Comprehensive information security management system audit template with evidence tracking.',
      industry: 'Compliance',
      isPublic: true,
      typeDefinition: {
    ...
    },
    {
      ...
      description:
        'Mobile-optimized industrial safety inspection for field agents tracking hazards and GPS location.',
      ...
      typeDefinition: {
        ...
        columns: [
          ...
          },
          {
            ...
            columnType: 'text',
            isRequired: true,
          }, // Placeholder, GPS is actually built-in
          {
