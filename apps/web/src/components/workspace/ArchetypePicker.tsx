    ...
    <div className="space-y-6">
        ...
        >
          ...
          <div className="flex-1">
            <h4 className="font-bold text-[var(--color-text-base)] flex items-center gap-2">
              Blank Project
              {selectedId === null && (
                <Check className="h-4 w-4 text-[var(--color-accent-base)]" />
              )}
            </h4>
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor: `${tpl.typeDefinition.typeColor}15`,
                    color: tpl.typeDefinition.typeColor,
                  }}
                >
                ...
                <div className="flex-1">
                  ...
                  {isSelected && (
                    <div className="mt-3 flex items-center gap-2 text-[10px] text-[var(--color-accent-base)] font-bold animate-in slide-in-from-left-2 duration-300">
                      ...
                      <span>
                        {tpl.typeDefinition.columns.length} pre-configured
      ...
      <div className="p-3 bg-amber-500/5 border border-amber-500/10 rounded-xl flex gap-3">
        ...
        <p className="text-xs text-amber-600/80 leading-relaxed">
          Selecting an archetype will automatically create the initial schema
          for your project. You can modify these columns later in the Schema
          Architect.
        </p>
      </div>
    </div>
