...
export const PhotoCapture: React.FC<PhotoCaptureProps> = ({
  ...
  return (
    <div className={cn("relative group overflow-hidden rounded-[2.5rem] bg-surface-lowest border border-white/5 shadow-obsidian", aspectRatio, className)}>
      {value ? (
        <div className="relative h-full w-full">
          <img src={value} alt="Captured" className="h-full w-full object-cover grayscale contrast-125 transition-all group-hover:grayscale-0 duration-700" />
        ...
        >
          ...
          <div className="text-center">
            <span className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] group-hover/btn:text-white/60 transition-colors">Initialize Visual Capture</span>
          </div>
        </button>
      )}
    </div>
