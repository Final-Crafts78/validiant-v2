...
export default function TermsPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-900 p-6 text-center text-white">
      ...
      <div className="mb-12 max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
      ...
      <Link
        href="/"
        className="rounded-lg bg-purple-600 px-8 py-3 font-medium text-white shadow-lg shadow-purple-500/20 transition-colors hover:bg-purple-700"
      >
        Return Home
      </Link>
    </div>
