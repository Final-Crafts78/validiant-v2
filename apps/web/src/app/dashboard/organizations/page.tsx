    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-20">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                 <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 transition-all group-hover:border-blue-100 dark:group-hover:border-blue-900/40">
                    ...
                    <p className="text-lg font-black text-slate-800 dark:text-white">{org.projectCount || 0}</p>
                 </div>
                 <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800 transition-all group-hover:border-indigo-100 dark:group-hover:border-indigo-900/40">
                    ...
                    <p className="text-lg font-black text-slate-800 dark:text-white">{org.memberCount || 0}</p>
                 </div>
              </div>
            </div>
        ...
        >
          ...
          <h4 className="text-lg font-black text-slate-400 group-hover:text-blue-600 transition-colors tracking-tight">Create Workspace</h4>
          <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mt-1">Initialize New Org Layer</span>
        </button>
      </div>
    </div>
  );
