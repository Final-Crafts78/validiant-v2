    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Updates and compliance notices for{' '}
            <span className="font-bold text-blue-600">{orgSlug}</span>
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="p-24 text-center">
            ...
            <p className="text-slate-500 max-w-xs mx-auto mt-2">
              You don&apos;t have any unread alerts at the moment. Keep up the
              good work!
            </p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="flex-1 space-y-2">
                  <div className="flex items-start justify-between">
                    <h4
                      className={`text-base leading-tight ${!n.readAt ? 'font-bold text-slate-900' : 'text-slate-600'}`}
                    >
                      {n.title}
                    </h4>
      ...
      <div className="text-center pb-12">
        <p className="text-xs text-slate-400">
          Showing notifications from the last 30 days. Older alerts are
