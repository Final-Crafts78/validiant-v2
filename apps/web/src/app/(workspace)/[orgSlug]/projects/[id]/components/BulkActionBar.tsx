  ...
  return (
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 animate-in fade-in slide-in-from-bottom-4 duration-300">
      <div className="bg-[var(--surface-container)] border border-primary/20 rounded-3xl shadow-2xl shadow-[#0c1324]/80 px-6 py-4 flex items-center gap-6 backdrop-blur-xl">
        {/* Selection Count */}
        <div className="flex items-center gap-3 pr-6 border-r border-[var(--color-border-base)]/40">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="h-10 px-4 flex items-center gap-2 bg-[var(--color-surface-muted)]/50 hover:bg-[var(--color-surface-muted)] text-[#dce1fb] rounded-xl transition-all"
          >
        ...
        <button
          onClick={onClear}
          className="ml-2 p-2 hover:bg-[var(--color-surface-muted)] rounded-full transition-colors text-[var(--text-muted)]"
