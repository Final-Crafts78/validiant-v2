...
export function StatusActionBar({
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 p-6 bg-surface-container-low/80 backdrop-blur-2xl border-t border-white/5 flex items-center justify-between z-10 animate-in slide-in-from-bottom-10 duration-700 delay-300">
