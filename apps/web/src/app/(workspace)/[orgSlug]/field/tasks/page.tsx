  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-1">
        <h1 className="text-3xl font-display font-black text-[var(--color-text-base)] tracking-tight">
          Active Assignments
        </h1>
        <p className="text-sm font-medium text-[var(--color-on-surface-variant)]">
          {activeCount} tasks requiring immediate action
        </p>
      </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mt-6 mb-4">
                <div className="flex flex-col">
                  <span className="text-[10px] uppercase font-bold text-[var(--color-on-surface-variant)] mb-1">
                    Type
                  </span>
              ...
              <div className="flex items-center justify-between pt-4 gap-4 border-t border-[var(--color-surface-container-high)]">
                <div className="flex -space-x-2">
                  <div className="w-8 h-8 rounded-full border-2 border-[var(--color-surface-container-lowest)] bg-[var(--color-surface-container-highest)] flex items-center justify-center text-[10px] font-bold z-20">
                    FE
                  </div>
                  <div className="w-8 h-8 rounded-full border-2 border-[var(--color-surface-container-lowest)] bg-[var(--color-surface-container-high)] flex items-center justify-center z-10">
      ...
      <div className="grid grid-cols-2 gap-3 pt-2">
        <div className="bg-[var(--color-surface-container-lowest)] rounded-2xl p-5 shadow-[0px_4px_16px_rgba(15,23,42,0.04)] flex flex-col justify-between h-[100px]">
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-black uppercase text-[var(--color-on-surface-variant)] tracking-widest">
              Active
            </span>
            <MapPin className="w-3 h-3 text-primary opacity-60" />
          </div>
          <p className="text-2xl font-display font-black text-[var(--color-on-surface)]">
            {activeCount}{' '}
