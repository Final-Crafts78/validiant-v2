...
export default function StatusPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-black p-6 text-center text-[var(--color-text-base)]">
      ...
      <Link
        href="/"
        className="rounded-lg bg-emerald-700 px-8 py-3 font-medium text-[var(--color-text-base)] shadow-lg shadow-emerald-500/20 transition-colors hover:bg-emerald-600"
      >
        Return Home
      </Link>
    </div>
